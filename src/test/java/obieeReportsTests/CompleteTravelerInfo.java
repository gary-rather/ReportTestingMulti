    ...
    public void completeTravelerInfo(String ctitShowFullSSN, String ctitOnlyTDY, String ctitNextTravelDateStart,
        ...
        if (config.getProperty("reportRequested").equalsIgnoreCase("complete traveler info")
            ...
            for(WebElement iframe : iframes){
                ...
                if ("idEmbed".equals(iframe.getAttribute("id"))){
                    continue;
                }

                System.out.println(i++ + " iframe  " +  iframe.getAttribute("id"));
                js.executeScript("arguments[0].scrollIntoView();", iframe);
                driver.switchTo().frame(iframe);

                WebElement title = driver.findElement(By.xpath("//a[contains(text(),'Details')]"));

                if ("Traveler Details".equals(title.getText())){
                ...
                } else if ("User Details".equals(title.getText())){
                ...
                } else if ("Personal Details".equals(title.getText())){
                ...
                } else if ("Account Details".equals(title.getText())){
                ...
                //System.out.println( " title  " + title.getTagName());
